...
The project was accelerated by the first UNODC Hackathon where Celo was part of the main sponsors and we won on the best implementation category. This inspired us to work on this project.
